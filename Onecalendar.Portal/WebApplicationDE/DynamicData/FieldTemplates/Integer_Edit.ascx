<%@ Control Language="C#" CodeBehind="Integer_Edit.ascx.cs" Inherits="WebApplicationDE.Integer_EditField" %>


<asp:TextBox ID="TextBox1" runat="server" Text='<%# FieldValueEditString %>' Columns="10" TextMode="Number"></asp:TextBox>
